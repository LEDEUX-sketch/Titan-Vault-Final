...
export default function AdminUsersPage() {
    ...
    const handleAction = async (action: "ban" | "unban" | "suspend" | "reactivate", userId: string) => {
        ...
        try {
            ...
            else if (action === "suspend") await suspendUser({ userId: id });
                                        ...
                                        <div style={{ display: "flex", justifyContent: "flex-end", gap: "8px" }}>
                                            {u.status === "active" && (
                                                <>
                                                    ...
                                                    <button style={S.actionBtn("suspend")} onClick={() => handleAction("suspend", u._id)} disabled={actionLoading === u._id + "suspend"}>
