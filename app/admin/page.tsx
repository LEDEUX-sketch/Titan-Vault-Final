        ...
        <>
            ...
            <div style={S.actionsGrid}>
                ...
                <Link href="/" style={S.actionCard}>
                    <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#ff6b6b" strokeWidth="1.5"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" /><polyline points="9 22 9 12 15 12 15 22" /></svg>
                    <h3 style={S.actionCardH3}>View Storefront</h3>
                    <p style={S.actionCardP}>Go back to the main customer store page.</p>
                </Link>
            </div>
        </>
    );
